...
# We DO use arduino-esp32 (as a managed component, wrapped by our local
# components/arduino/ shim). Without this, LovyanGFX's LGFXBase compiles
# WITHOUT the ARDUINO macro, so its `class LGFXBase : public Print` base
# class is omitted. main.cpp meanwhile sees ARDUINO defined and inherits
# Print -> the object layout disagrees between the two TUs, and
# setPanel/getPanel write/read `_panel` at different offsets.
